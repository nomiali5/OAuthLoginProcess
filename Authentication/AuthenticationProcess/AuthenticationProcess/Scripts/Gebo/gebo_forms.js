...
//* bootstrap datepicker
	gebo_event_datepicker = {
	    init: function () {
	        var today = new Date();
	        var now = new Date();
	        now.setDate(today.getDate() - 1);

	        $('#event_dp_start').datepicker('setStartDate', now);
	        $('#event_dp_end').datepicker('setStartDate', now);

	        $('#event_dp_start').datepicker({ format: "mm/dd/yyyy" }).on('changeDate', function (ev) {

	            var dateText = $(this).data('date');

	            //var endDateTextBox = $('#event_dp_end input');
	            ...
	            //$('#event_dp_end').datepicker('setStartDate', sd);
	            $('#event_dp_start').datepicker('hide');
	        });
	        $('#event_dp_end').datepicker({ format: "mm/dd/yyyy" }).on('changeDate', function (ev) {

	            var dateText = $(this).data('date');
	            //var startDateTextBox = $('#event_dp_start input');
	            ...
	            $('#tp_End').val(end_time);
	            //$('#event_dp_start').datepicker('setEndDate', sd);
	            $('#event_dp_end').datepicker('hide');
	        });
	...
	gebo_datepicker = {
		init: function() {
			...
			$('#dp1N').datepicker();
			$('#dp1I').datepicker();
			//$('#event_dp_start').datepicker({ format: "mm/dd/yyyy" });
			//$('#event_dp_end').datepicker({ format: "mm/dd/yyyy" });
